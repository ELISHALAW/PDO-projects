...
<body class="bg-gray-950 text-gray-200 overflow-hidden">
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar -->
        <aside class="w-72 bg-gray-900 border-r border-gray-800 flex-shrink-0 flex flex-col">
            <!-- Logo -->
            <div class="p-6 border-b border-gray-800">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center text-2xl">
                        💻
                    </div>
                    <div>
            ...
            <div class="p-4 border-t border-gray-800 mt-auto">
                <a href="logout.php" 
                   class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl text-red-400 hover:bg-red-950/50 hover:text-red-300">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-gray-900 border-b border-gray-800 px-6 py-4 flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <button id="mobile-menu" class="lg:hidden text-2xl text-gray-400 hover:text-white">
                        <span class="la la-bars"></span>
                    </button>
                    <div>
                        <h2 class="text-2xl font-semibold text-white"><?php echo htmlspecialchars($adminPageTitle); ?></h2>
                        <p class="text-sm text-gray-500"><?php echo htmlspecialchars($adminPageSubtitle); ?></p>
                    </div>
                </div>

                <div class="flex items-center gap-6">
                    <!-- Search -->
                    <form method="get" class="hidden md:flex items-center bg-gray-800 rounded-2xl px-4 py-2 w-80 focus-within:w-96 transition-all">
                        <span class="la la-search text-gray-500"></span>
                        <input 
                            name="search" 
                            type="search" 
                            placeholder="Search products, orders..." 
                            value="<?php echo htmlspecialchars($search); ?>"
                            class="bg-transparent outline-none ml-3 text-sm flex-1 placeholder-gray-500"
                        >
                    </form>
                    ...
                    <button class="relative p-3 hover:bg-gray-800 rounded-2xl transition-colors">
                        ...
                        <span class="absolute top-2 right-2 w-5 h-5 bg-red-500 text-[10px] font-bold flex items-center justify-center rounded-full">3</span>
                    </button>

                    <!-- User Profile -->
                    <div class="flex items-center gap-3">
                        <img src="amos2.jpg" alt="Admin" 
                             class="w-9 h-9 rounded-2xl object-cover border border-gray-700">
                        <div>
                            <div class="font-medium text-sm"><?php echo htmlspecialchars($query['username']); ?></div>
